...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <label class="col-md-2 control-label">VoiceClip Upload <span class="required"></span></label>
                                <div class="col-md-8">
                                   <asp:FileUpload ID="flupvoiceClip"  runat="server"/> 
                                </div>
                                <div class="col-md-2">
                                    <asp:Button runat="server" ID="btn_Audio" Text="Upload"  CssClass="btn btn-primary"  OnClick="btn_Audio_Click"/>
                                </div>
                          
                            <%--  <audio controls="controls"><source src="VoiceUpload/file_example_MP3_700KB.mp3" type="audio/mpeg" autoplay="autoplay" /></audio>--%>
                            <div class="col-md-12">
                                <asp:Literal runat="server" ID="ltrVoice"> </asp:Literal>
                            </div>
